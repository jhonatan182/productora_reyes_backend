...
export const guardarDetalleFacturacion = async (req,res) =>{
    const {id_producto, id_factura, cantidad, precio_unitario} = req.body;
    if (!id_producto || !id_producto || !cantidad || !precio_unitario ) {
        res.send("Debe enviar los datos completos");
    }
    else {
            await Detalle_Facturacion.create({
